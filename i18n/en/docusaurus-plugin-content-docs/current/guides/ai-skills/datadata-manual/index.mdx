...
description: Complete guide to the datadata-manual skill and Datadata MCP Server.
---
...
> **For generating standalone Python scripts (crawlers/ETL/batch), use the [`datadata-rest-api`](/docs/guides/ai-skills/datadata-rest-api/) skill.** MCP is designed for chat interaction and is not suitable for generating independently runnable script files.
